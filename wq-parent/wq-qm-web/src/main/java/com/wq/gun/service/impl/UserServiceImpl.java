package com.wq.gun.service.impl;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.qm.utils.DateUtil;
...
import com.wq.common.shiro.ShiroRealm;
import com.wq.common.util.PageDataResult;
import com.wq.common.util.SendMsgServer;
import com.wq.gun.mapper.RoleMapper;
import com.wq.gun.mapper.UserMapper;
import com.wq.gun.mapper.UserRoleMapper;
import com.wq.gun.model.Role;
import com.wq.gun.model.User;
import com.wq.gun.model.UserRoleKey;
import com.wq.gun.service.UserService;
        ...
        if (null != existUser && existUser.getMobile().equals(user.getMobile())) {
            ...
            if (existUser.getSendTime() != null) {
                ...
                if (((endTime - beginTime) < 60000)) {
                    log.debug("发送短信验证码【wyait-manager-->UserServiceImpl.sendMsg】用户信息=existUser:"
                            + existUser);
